function arrayQuizData() {
  var questions = [
...

    {
      numb: 4,
      question:
        "Entries in a stack are . What is the meaning of this statement?",
...

    {
      ...
      answer: "Pod",
      options: ["Create", "Push", "Evaluation", "Pod"],
    },
  ...
  var questions = [
    {
      ...
      options: ["O(log n)", "O(log h)", "O(h)", "O(log n) and O(h)"],
    },
    {
      numb: 2,
      question:
    ...
    },
    {
      ...
      answer: "Heapify",
      options: ["Heapify", "Hashing", "Linking", "Merging"],
    },
    {
      numb: 5,
      question:
    ...
    },
    {
      numb: 8,
      question:
        "8.	The worst case complexity of deleting any arbitrary node value element from heap is __________.",
      answer: "O(logn)",
...
function binarysearchQuizData() {
  var questions = [
    ...
    },
    {
      ...
      answer: "O(log n)",
      options: ["O(n0.5)", "O(n)", "O(log n)", "O(n log n)"],
    },
    {
      numb: 9,
      question:
    ...
    },
    {
      ...
      answer: "h = O(log n)",
      options: ["h = O(loglogn)", "h = O(nlogn)", "h = O(n)", "h = O(log n)"],
    },
    {
      numb: 20,
      question:
...
function linkedlistQuizData() {
  var questions = [
...

    {
      ...
      answer: "O(n)",
      options: ["O(1)", "O(n)", "O(logn)", "None of the mentioned"],
    },
...

    {
      ...
      answer: "Two pointer",
      options: ["One pointer", "Two pointer", "Three pointer", "None"],
    },
...

    {
      ...
      answer: "O(n)",
      options: ["O(1)", "O(n)", "O(n2)", "None of the mentioned"],
    },
...

    {
      ...
      answer: "Dynamic",
      options: ["Dynamic", "Static", "Compile time", "None of the mentioned"],
    },
  ...
  var questions = [
    {
      numb: 1,
      question:
        "A linear list of elements in which deletion can be done from one end (front) and insertion can take place only at the other end (rear) is known as ___________",
      answer: "Queue",
    ...
    },
    {
      ...
      answer: "AVAIL",
      options: ["AVAIL", "FRONT", "REAR", "None of the above"],
    },
    {
      numb: 8,
      question:
    ...
    },
    {
      numb: 10,
      question:
        "Consider a standard Circular Queue q implementation whose size is 11 and the elements of the queue are q[0], q[1], q[2]…..,q[10].The front and rear pointers are initialized to point at q[2] . In which position will the ninth element be added?",
      answer: "q[0]",
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function changeVideo(event) {
    ...
    info.querySelector(".profile-title").textContent =
      infoData[videoIndex].name;
    info.querySelector(".profile-name").textContent =
      infoData[videoIndex].title;
  ...
  var videoIndex = url.searchParams.get("id");
...
var infoData = [
  {
    ...
    image:
      "https://www.milkround.com/advice/wp-content/uploads/how-to-take-a-good-linkedin-photo-1024x576.jpg",
  },
  {
    name: "Jane Smith",
    title: "Software Engineer",
    image:
      "https://cdn.openart.ai/uploads/image_Sg__ilLp_1698687691182_raw.jpg",
  },
  {
    name: "Joe Doe",
    title: "Product Designer",
    image:
      "https://onlineprofilepros.com/wp-content/uploads/2017/12/profile-photo.jpeg",
  },
  {
    name: "Shradha Didi",
    title: "Engineer & Teacher",
    image:
      "https://media.licdn.com/dms/image/D4D03AQHGNAxeyJhZbQ/profile-displayphoto-shrink_800_800/0/1685972237021?e=2147483647&v=beta&t=FceaUKIQSGe-o1AaXSPct6VQdwcopX-ejFhb4jQj-AE",
  },
  {
    name: "Heer Mehta",
    title: "Financial Analyst",
    image:
      "https://www.hagopsphotography.com/wp-content/uploads/2021/10/Female-LinkedIn-portrait.jpg",
  },
  {
    name: "Danush Nadar",
